...
def generate_svm_hpo_dataset(dimension, eps):
    ...
    data_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'synthetic_2d', 'svm_hpo_data.npz')
    ...
    if not os.path.exists(data_path):
        raise FileNotFoundError(
            "svm_hpo_data.npz not found. Run synthetic_2d/generate_hpo_data.py first."
        )
