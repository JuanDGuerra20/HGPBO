...
def training_procedure(nbr_query, nbr_repetition, nbr_rand_init, dimension, training_iter, k_vals, data_name, data_creation_func,
    ...
    workspace = f"C:/Users/preda/PycharmProjects/HierarchicalGPBO/model_testing/{data_name}/vanilla"
    ...
    for kappa in k_vals:
        ...
        plt.savefig(
            f'{data_name}/vanilla{folder_of_the_day}/differentiable_plots/vanilla_Prop_{data_name}_HGP-BO_{nbr_repetition}_repetitions_kappa_{k}')
        plt.close()
