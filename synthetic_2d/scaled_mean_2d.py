...
def training_procedure(nbr_query, nbr_repetition, nbr_rand_init, dimension, training_iter, k_vals, g_vals, nu_vals,
    ...
    elif hierarchical_model == hmodel.Lossless_ScaledMean_GP:
        model_name = "Lossless_ScaledMean"
...
if __name__ == '__main__':
    ...
    multi = True
    acq = 'ucb'
    h_model = [hmodel.Lossless_ScaledMean_GP]
    process = []
    ...
    over_child_r2 = []
    over_auc = []
    for dataset_num in [2,3,10,11,12,13]:
        for h in h_model:
            ...
            elif h == hmodel.Lossless_ScaledMean_GP:
                model_name = "Lossless_ScaledMean"
