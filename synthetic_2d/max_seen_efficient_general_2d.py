...
from efficient_synthetic_script import joint_performance
...
def run_repetition(kappa, gamma, nu, nbr_query, nbr_rand_init, dimension, training_iter, hierarchical_model,
                   data_creation_func, eps, model_name, folder_of_the_day, data_name, final=False, children=[], visualize=True, seed=True, noise=0.1, alpha=0, disable_tqdm=False):
...
def training_procedure(nbr_query, nbr_repetition, nbr_rand_init, dimension, training_iter, k_vals, g_vals, nu_vals,
                       data_name, data_creation_func, eps, hierarchical_model, multi, seed, children=[], visualize=True, noise=0.1, alpha=0, disable_tqdm=False):
    if hierarchical_model == hmodel.Efficient_UCB_Hierarchical_GP:
        ...
        model_name = "Lossless_Efficient_Max_Seen"
                    ...
                    with mp.Pool(processes=nbr_repetition - 1) as pool:
                        ...
                        try:
                            master, sub1, sub2, rep_exploration_score, rep_exploitation_score, heatmap_rep, child_1_r2, child_2_r2 = run_repetition(
                                ...
                                children=children, visualize=visualize, seed=seed[-1], noise=noise, disable_tqdm=disable_tqdm)
                        except:
                            try:
                                master, sub1, sub2, rep_exploration_score, rep_exploitation_score, heatmap_rep, child_1_r2, child_2_r2 = run_repetition(
                                    kappa, gamma, nu, nbr_query, nbr_rand_init, dimension, training_iter,
                        ...
                        try:
                            ...
                            try:
                                master, sub1, sub2, rep_exploration_score, rep_exploitation_score, heatmap_rep, child_1_r2, child_2_r2 = run_repetition(
                                    ...
                                    hierarchical_model,
                                    data_creation_func, eps, model_name, folder_of_the_day, data_name, final=True,
                                    children=children, visualize=visualize, seed=seed[i] + 1, noise=noise, disable_tqdm=disable_tqdm)
                            except:
                                try:
                                    master, sub1, sub2, rep_exploration_score, rep_exploitation_score, heatmap_rep, child_1_r2, child_2_r2 = run_repetition(
                                        kappa, gamma, nu, nbr_query, nbr_rand_init, dimension, training_iter,
